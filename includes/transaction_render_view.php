<div style="margin: 10px; padding: 10px;" class="panel panel-info">
		...
		<div class="tab-content">
			...
			<ul class="list-group">
				...
				<li class="list-group-item"><h5><label>Payment Type:</label><?php echo $this->translatePaymentType($xml->paymentMethod->type->__toString()); ?></h5></li>
				<li class="list-group-item"><h5><label>Payment Method:</label><?php echo $this->translatePaymentMethod($xml->paymentMethod->code->__toString()); ?></h5></li>
			</ul>
			</div>
			</div>
			</div>
